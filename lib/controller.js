...
module.exports = function (options, rootRouter, interceptorManager, Promise) {
    ...
    Controller.prototype.add = function (parameters) {
        ...
        fn(path, (req, res) => {
            ...
            promise.then(() => this.defaultAction && this.defaultAction(req, res))
                .then(() => interceptorManager.intercept(parameters, req, res, callback))
    ...
    Controller.prototype.patch = function (path, callback, options) {
        return this.internalAdd(Controller.PATCH, path, callback, options);
    };
